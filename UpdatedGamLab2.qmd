...
8.  Visualize the GAM (R has some good built-in plotting functions, such as plot.gam()).

9.  Choose a value of X that is important or interesting (explain why) and use that point to make a prediction for Y. Interpret this prediction.

10. How does the GAM compare with a linear method (e.g., lasso, ridge, PCR, etc.)?
