...
1.  Summarize the models' performance using all of the results from each individual.
    ...
    performance_df <- data.frame(
      ...
      LDA_Sensitivity = c(0.6854991,0.6854991)
      LDA_Specificity = c(0.4818763,lda_sensitivity)
      LDA_ErrorRate = c(0.410,lda_misclassification)
      QDA_Sensitivity = c(0.5762712,qda_sensitivity)
      QDA_Specificity = c(0.6695096,qda_specificity)
      QDA_ErrorRate = c(0.380,qda_misclassification)
      NaiveBayes_Sensitivity = c(0.6403013,nb_sensitivity)
      NaiveBayes_Specificity = c(0.6055437,nb_specificity)
      NaiveBayes_ErrorRate = c(0.376,nb_misclassification)
      KNN_Sensitivity = c(0.6346516,knn6_sensitivity)
      KNN_Specificity = c(0.5309168,knn6_specificity
      KNN_ErrorRate = c(0.414,knn6_misclassification)
    )
