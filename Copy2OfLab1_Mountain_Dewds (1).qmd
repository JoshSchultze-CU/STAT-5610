...
1.  Summarize the models' performance using all of the results from each individual.
    ...
    performance_df <- data.frame(
      ...
      Logistic_Regression_Sensitivity = c(0.3333333,0.6679389)
      Logistic_Regression_Specificity = c(0.8528785,0.6679389)
      Logistic_Regression_ErrorRate = c(0.423,0.5916031)
      LDA_Sensitivity = c(0.6854991,0.5084034)
      LDA_Specificity = c(0.4818763,0.5084034)
      LDA_ErrorRate = c(0.410,0.5756303)
      QDA_Sensitivity = c(0.5762712,0.4201681)
      QDA_Specificity = c(0.6695096,0.7328244)
      QDA_ErrorRate = c(0.380,0.6221374)
      NaiveBayes_Sensitivity = c(0.6403013,0.4080000)
      NaiveBayes_Specificity = c(0.6055437,0.4201681)
      NaiveBayes_ErrorRate = c(0.376,0.4789916)
      KNN_Sensitivity = c(0.6346516,0.4160000)
      KNN_Specificity = c(0.5309168,0.4160000)
      KNN_ErrorRate = c(0.414,0.4460000)
    )
