...
performance_df <- data.frame(
  ...
  KNN_Sensitivity = c(0.6346516, 0.4160000, 0.6985138,0.5855513),
  KNN_Specificity = c(0.5309168, 0.4160000, 0.7637051,0.5738397),
  KNN_ErrorRate = c(0.414, 0.4460000, 0.267,0.42)
)
