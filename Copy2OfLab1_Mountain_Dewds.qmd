...
1.  Summarize the models' performance using all of the results from each individual.
    ...
    Below is a summary of the averaged sensitivity, specificity, and classification rates for each model
    ...
    **KNN with 6**
    ...
    ```{r}
    knn6_avg_specificty
    knn6_avg_sensitivity
    knn6_avg_misclassification
    ```
...
performance_df <- data.frame(
  Individual = c("Rishi"),
  Logistic_Regression_Sensitivity = c(0.3333333),
  Logistic_Regression_Specificity = c(0.8528785),
  Logistic_Regression_ErrorRate = c(0.423),
  LDA_Sensitivity = c(0.6854991),
  LDA_Specificity = c(0.4818763),
  LDA_ErrorRate = c(0.410),
  QDA_Sensitivity = c(0.5762712),
  QDA_Specificity = c(0.6695096),
  QDA_ErrorRate = c(0.380),
  NaiveBayes_Sensitivity = c(0.6403013),
  NaiveBayes_Specificity = c(0.6055437),
  NaiveBayes_ErrorRate = c(0.376),
  KNN_Sensitivity = c(0.6346516),
  KNN_Specificity = c(0.5309168),
  KNN_ErrorRate = c(0.414)
)
