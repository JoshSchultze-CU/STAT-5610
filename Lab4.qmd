...
2.  Interpret your results. To what degree do your $K$ clusters correspond to the four groups?
    ...
    Using this output, we can see that the cluster's corresponded fairly well to actual group inclusion. Cluster 2 was the only with perfect classification, but the other clusters only had relatively few classifications each.
